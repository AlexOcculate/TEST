   ...
   public partial class DataStoreXtraForm : DevExpress.XtraEditors.XtraForm
   {
      ...
      private void ConfigGridControl()
      {
         ...
         ((System.ComponentModel.ISupportInitialize) (this.gridView1)).BeginInit( );
         {
            ...
            this.gridView1.Columns[ DataStore.NOTIFICATION_WHEN_STARTED_FIELDNAME ].Visible = false;
            this.gridView1.Columns[ DataStore.NOTIFICATION_WHEN_FINISHED_FIELDNAME ].Visible = false;
            ...
            this.gridView1.Columns[ DataStore.NOTIFICATION_WHEN_STARTED_FIELDNAME ].Caption = DataStore.NOTIFICATION_WHEN_STARTED_DISPLAYNAME;
            this.gridView1.Columns[ DataStore.NOTIFICATION_WHEN_FINISHED_FIELDNAME ].Caption = DataStore.NOTIFICATION_WHEN_FINISHED_DISPLAYNAME;
