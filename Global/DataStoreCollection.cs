namespace AQBTest
{
   ...
   public partial class DataStoreCollection
   {
      ...
      [System.Xml.Serialization.XmlArrayItem( typeof( AQBTest.DataStore ), ElementName = "DS" )]
      public System.ComponentModel.BindingList<AQBTest.DataStore> List { get; set; }
      #endregion
      ...
      {
         System.Xml.Serialization.XmlSerializer xs = new System.Xml.Serialization.XmlSerializer( typeof( AQBTest.DataStoreCollection ) );
