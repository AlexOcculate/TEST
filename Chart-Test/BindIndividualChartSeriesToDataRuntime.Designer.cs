...
{
   partial class BindIndividualChartSeriesToDataRuntime
   {
      /// <summary>
      ...
      private void InitializeComponent()
      {
         ...
         // 
         // BindIndividualChartSeriesToDataRuntime
         // 
         ...
         this.Name = "BindIndividualChartSeriesToDataRuntime";
         this.Text = "BindIndividualChartSeriesToDataRuntime";
         this.Load += new System.EventHandler(this.BindIndividualChartSeriesToDataRuntime_Load);
